...
<body>
                    ...
                    <fieldset>
                        ...
                        <div class="join__box">
                            ...
                            <div class="overlap">
                                ...
                                <input type="email" id="youEmail" name="youEmail" placeholder="이메일을 입력해 주세요.">
                            ...
                            <div class="overlap">
                                ...
                                <input type="text" id="youNickName" name="youNickName" placeholder="닉네임을 입력해 주세요.">
                                <a href="#c" class="check" onclick="nickChecking()">중복검사</a>
                                <p class="msg" id="youNickNameComment"><!-- *닉네임이 존재합니다. --></p>
                            </div>
                            <div>
                                <label for="youName">이름</label>
                                <input type="text" id="youName" name="youName" placeholder="이름을 입력해 주세요." maxlength="5">
                                <p class="msg" id="youNameComment"><!-- *이름은 한글로만 작성이 가능합니다. --></p>
                            </div>
                            <div>
                                <label for="youPass">비밀번호</label>
                                <input type="password" id="youPass" name="youPass" placeholder="비밀번호를 입력해 주세요." maxlength="20">
                                <p class="msg" id="youPassComment"><!-- *비밀번호는 특수기호, 숫자가 들어가야 합니다. --></p>
                            </div>
                            <div>
                                <label for="youPassC">비밀번호 확인</label>
                                <input type="password" id="youPassC" name="youPassC" placeholder="비밀번호를 동일하게 입력해 주세요." maxlength="20">
                                <p class="msg" id="youPassCComment"><!-- *비밀번호가 일치하지 않습니다. --></p>
                            </div>
                            <div>
                                <label for="youBirth">생년월일</label>
                                <input type="text" id="youBirth" name="youBirth" placeholder="YYYY-MM-DD" maxlength="15">
    ...
    <script>
        ...
        function joinChecks(){
            ...
            // 닉네임 중복 검사
            if(nickCheck == false){
                $("#youNickNameComment").text("닉네임 중복검사를해주세요.");
                return false;
            }
            // 비밀번호 공백 검사
            if($("#youPass").val() == ''){
