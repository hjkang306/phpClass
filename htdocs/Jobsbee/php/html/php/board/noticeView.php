                ...
                <div class="notice_table">
                    <table>
                        ...
                        <?php
                            ...
                            $sql = "SELECT n.noticeTitle, m.youName, n.regTime, n.noticeContents FROM myNotice n JOIN myMember m ON(m.myMemberID = n.myMemberID) WHERE n.myNoticeID = {$myNoticeID};";
                    ...
                    <div class="noticeViewBtn">
                        ...
                        <a href="./noticeDelete.php?myNoticeID=<?=$myNoticeID?>" class="btn3" onClick="return alert('정말 삭제하시겠습니까?')">삭제하기</a>
