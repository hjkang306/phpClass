    ...
    <section id="login__box">
        <div class="login__inner LoginMain">
            ...
            <div class="login__service">
                <a href="join.php" class="join btn3">회원가입</a>
        ...
        <div class="login__inner SearchIDPhone">
            ...
            <form action="" method="post">
                <fieldset>
                    ...
                    <div>
                        <label for="SearchIDPhoneEmail" class="blind">이메일 입력</label>
                        <input type="email" name="SearchIDPhoneEmail" id="SearchIDPhoneEmail" placeholder="이메일 입력" required>
                    </div>
