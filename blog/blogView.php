        ...
        <section id="blog" class="container">
            <div class="blog__inner">
                ...
                <div class="blog__contents">
                    ...
                    <div class="blog__contents__cont"><?=$blogInfo['blogContents']?></div>
        ...
        <div class="comment" id="comment<?=$comment['myCommentID']?>">
            <div class="comment__view">
                <div class="comment__view__img">
                    <img src="../assets/img/icon_256.png" alt="이미지">
                </div>          
...
?>
                        ...
                        <div class="comment__write">
                            <div class="comment__write__info">
                                ...
                                <input type="text" id="commentName" name="commentName" placeholder="이름을 입력해 주세요">
                                <label for="commentPass">비밀번호</label>
                                <input type="password" id="commentPass" name="commentPass" placeholder="비밀번호 입력해 주세요">
                                <button type="submit" id="commentBtn">댓글 쓰기</button>
                            </div>
                            <div class="comment__write__msg">
                                <label for="commentWrite">댓글 작성란</label>
