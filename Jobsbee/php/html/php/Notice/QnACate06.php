    ...
    <main id="main" class="QnA">
        <div class="subMenu">
            ...
            <nav>
                <ul>
                    ...
                    <li class="active"><a href="http://bb020440.dothome.co.kr/php/Notice/QnACate06.php">분류6</a></li>
                </ul>
            </nav>
        </div>
        ...
        <section id="QnA__wrap">
            <div class="QnA__inner container">
                ...
                <!-- // 상단 메뉴 -->
                    <?php
                        ...
                        $sql = "SELECT * FROM myQnA WHERE QnACategory=6 ORDER BY myQnAID ASC LIMIT {$viewLimit}, {$viewNum}";
            ...
            <div class="qna__page">
                <ul>
            <?php
                $sql = "SELECT count(myQnAID) FROM myQnA WHERE QnACategory=6;";
                $result = $connect -> query($sql);
