    ...
    <main id="main" class="QnA">
        <div class="subMenu">
            ...
            <nav>
                <ul>
                    ...
                    <hr>
                    <li class="active"><a href="http://bb020440.dothome.co.kr/php/Notice/QnACate04.php">분류4</a></li>
        ...
        <section id="QnA__wrap">
            <div class="QnA__inner container">
                ...
                <!-- // 상단 메뉴 -->
                    <?php
                        ...
                        $sql = "SELECT * FROM myQnA WHERE QnACategory=4 ORDER BY myQnAID ASC LIMIT {$viewLimit}, {$viewNum}";
            ...
            <div class="qna__page">
                <ul>
            <?php
                $sql = "SELECT count(myQnAID) FROM myQnA WHERE QnACategory=4;";
                $result = $connect -> query($sql);
