...
<body>
    ...
    <main id="main" class="QnA">
        <div class="subMenu">
            ...
            <nav>
                <ul>
                    <li class="active"><a href="http://bb020440.dothome.co.kr/php/Notice/QnACate01.php">분류1</a></li>
                    <li><a href="http://bb020440.dothome.co.kr/php/Notice/QnACate02.php">분류2</a></li>
                    <li><a href="http://bb020440.dothome.co.kr/php/Notice/QnACate03.php">분류3</a></li>
                    <hr>
        ...
        <section id="QnA__wrap">
            <div class="QnA__inner container">
                ...
                <!-- // 상단 메뉴 -->
                    <?php
                        ...
                        $sql = "SELECT * FROM myQnA WHERE QnACategory=1 ORDER BY myQnAID ASC LIMIT {$viewLimit}, {$viewNum}";
            ...
            <div class="qna__page">
                <ul>
            <?php
                $sql = "SELECT count(myQnAID) FROM myQnA WHERE QnACategory=1;";
                $result = $connect -> query($sql);
    ...
    <script>
        ...
        // 따봉과 즐찾 누르게 하기
        const ddabongs = document.querySelectorAll('.star');
        const bookMarks = document.querySelectorAll('.like');

        ddabongs.forEach((ddabong) => {
            ddabong.addEventListener('click', () => {
                ddabong.innerHTML = Number(ddabong.innerHTML) + 1;
            });
        });

        bookMarks.forEach((bookMark) => {
            bookMark.addEventListener('click', () => {
                bookMark.innerHTML = Number(bookMark.innerHTML) + 1;
            });
        });
