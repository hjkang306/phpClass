    ...
    <main id="main" class="QnA">
        <div class="subMenu">
            ...
            <nav>
                <ul>
                    ...
                    <li class="active"><a href="http://bb020440.dothome.co.kr/php/Notice/QnACate02.php">분류2</a></li>
        ...
        <section id="QnA__wrap">
            <div class="QnA__inner container">
                ...
                <!-- // 상단 메뉴 -->
                    <?php
                        ...
                        $sql = "SELECT * FROM myQnA WHERE QnACategory=2 ORDER BY myQnAID ASC LIMIT {$viewLimit}, {$viewNum}";
            ...
            <div class="qna__page">
                <ul>
            <?php
                $sql = "SELECT count(myQnAID) FROM myQnA WHERE QnACategory=2;";
                $result = $connect -> query($sql);
