    ...
    <main id="main">
        <section id="banner">
            ...
            <div class="banner__inner2 container">
                <div class="img">
                    <img src="../assets/img/banner_img02.svg" alt="배너 이미지1">
                </div>
                <div class="desc">
...
<?php
    ...
    // if($checkEmail == false){
    //     msg("이메일이 잘못되었습니다. 올바른 이메일로 작성해 주세요.");
    //     exit;
    // }
    ...
    if($checkName == false){
        msg("이름이 정확하지 않습니다. 한글로만 입력해 주세요.");
        exit;
    }
    ...
    if($checkNumber == false){
        msg("번호가 정확하지 않습니다. 올바를 휴대폰 번호(000-0000-0000)를 입력해 주세요.");
        exit;
    }
    ...
    if($result){
        ...
        if($count == 0){
            ...
            //로그인 유도
            msg("이미 회원가입이 되어있습니다. 로그인 해주세요^0^");
            exit;
        }
    } else {
